                    ...
                    <li>
                        <form action="index.php" method="get">
                            <div class="input-group">
                                ...
                                <button class="btn btn-primary" name="search-btn">
                                    Go
                                </button>
                            </div>
                        </form>
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <div class="list-group">
                    ...
                    $query = mysqli_query($conn, query:"SELECT * FROM category");
            ...
            <div class="col-lg-9">
                ...
                if(isset($_GET['search-btn'])){
                    $search =$_GET['search'];
                    $query = mysqli_query($connection, query:"SELECT * FROM products WHERE title LIKE '%$search%' OR description LIKE '%$search%'");
                }elseif(isset($_GET['cat'])){
                   $cat =$_GET['cat']; 
                   $query = mysqli_query($conn, query:"SELECT * FROM products WHERE cat_id='$cat'");
                }
                else{
                $query = mysqli_query($conn, query:"SELECT * FROM products");
                }
                while($row = mysqli_fetch_array($query)):
                ?>
