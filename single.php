...
<?php $id = $_GET['id'];
$query = mysqli_query($conn , query:"SELECT *FROM products WHERE id='$id'");
...
<div class="list-group">
    ...
    $cat_query = mysqli_query($conn, query:"SELECT * FROM category");
                ...
                <div class="card mt-4">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="index.php?cat=<?php echo $row['cat_id']; ?>" class="float-right">
                           <?php
                           $cat_id = $row['cat_id'];
                           $get_cat_post= mysqli_query($conn, query:"SELECT * FROM category WHERE id='$cat_id'");
